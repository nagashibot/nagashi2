...
const { porno1 } = require('./src/porno1')
...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:GOKU BOOT\n' // Nama kamu
            + 'ORG:Lexa;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=15135974358:+1 (513) 597-4358/n' //Nomor whatsapp kamu
            + 'END:VCARD'
prefix = '*'
blocked = []
limitawal = '999999999'
...
async function starts() {
	...
	client.on('open', () => {
		success('2', 'Conectado parça vlw por usar o boot GOKU')
	})
	...
	denz.on('group-participants-update', async (anu) => {
		...
		try {
			...
			if (anu.action == 'add') {
				num = anu.participants[0]
				try {
					ppimg = await client.on.getProfilePicture(`${anu.participants[0].split('@')[0]}@c.us`)
				} catch {
					ppimg = 'https://i0.wp.com/www.gambarunik.id/wp-content/uploads/2019/06/Top-Gambar-Foto-Profil-Kosong-Lucu-Tergokil-.jpg'
				}
				teks = `bai bai amigo tchau@${num.split('@')[0]} 𝚔𝚔𝚔𝚔𝚔𝚔𝚔 😂👋`
		...
		try {
			...
			mess = {
				...
				only: {
					...
					mod: '[𝗔𝗧𝗘𝗡𝗖𝗔𝗢] ESTE PEDIDO É ESPECÍFICO PARA USUARIO MOD GOKU BOT*',
					benned: 'Você para a banda, por favor, contate o proprietário para abrir sua banda',
					ownerG: '[𝗔𝗧𝗘𝗡𝗖𝗔𝗢] GOKU BOOT? Este é um recurso especial para o william ❌',
					ownerB: '[𝗔𝗧𝗘𝗡𝗖𝗔𝗢] GOKU BOOT? Este é um recurso especial para o william ❌',
					userB: `──「 LISTA 」──\nOlá Kak !\nDesculpe, irmã. Você não está registrado como amigo do Meliodas. Registre-se para fazer amizade com o bot ✞︎GOKU boot DOMINA✞︎ por meio, \n\nCommand : ${prefix}daftar nome|idade\nExemplo : ${prefix}daftar ✞︎GOKU boot DOMINA✞︎|17\n\n──「 BOT MAN 」──`,
			...
			const ownerNumber = ["15135974358@s.whatsapp.net","558981246187@s.whatsapp.net"] // replace this with your number
			const mod = [ownerNumber,"15135974358@s.whatsapp.net","558981246187@s.whatsapp.net"]//ubah nomor lo
			const adminbotnumber = ["5514991357606@s.whatsapp.net","558981246187@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["15135974358@s.whatsapp.net","558981246187@s.whatsapp.net"]//ubah nomor lo
			const premium = ["15135974358@s.whatsapp.net","1 513 5974358@s.whatsapp.net","558981204807@s.whatsapp.net","558981213553@s.whatsapp.net","55489184-3177@s.whatsapp.net"]
...
if (text.includes("placa"))
  ...
  conn.sendMessage(id, hasil, MessageType.text); 
		...
		setTimeout( () => {
			client.updatePresence(from, Presence.composing)
			reply("Nesse grupo, não gostamos de racismos, que isso sirva de exemplo otario kkkkk tchau🚶")
		}, 4000)
		setTimeout( () => {
			client.updatePresence(from, Presence.composing)
			reply("2 segundos")
		...
		if (messagesC.includes("#izinadmin")) return reply("#izinadmin diterima")
		var kic = `${sender.split("@")[0]}@s.whatsapp.net`
		reply(`link detectado ${sender.split("@")[0]} voce sera expulso deste grupo em 5 segundo descupa tchau otario`)
		setTimeout( () => {
			client.groupRemove(from, [kic]).catch((e)=>{reply(`*ERR:* ${e}`)})
		}, 5000)
		setTimeout( () => {
	...
	if (messagesC.includes("filha da puta")){
		...
		var kic = `${sender.split("@")[0]}@s.whatsapp.net`
		reply(`tchau hahahah ${sender.split("@")[0]} voce sera expulso deste grupo em 5 segundos`)
		setTimeout( () => {
			client.groupRemove(from, [kic]).catch((e)=>{reply(`*ERR:* ${e}`)})
		}, 4000)
		setTimeout( () => {
			client.updatePresence(from, Presence.composing)
			reply("1 na prosima nao xingue")
		}, 3000)
		setTimeout( () => {
			client.updatePresence(from, Presence.composing)
			reply("2 segundos")
		...
		setTimeout( () => {
			client.updatePresence(from, Presence.composing)
			reply("i ja foi kkkkkk tchau 🤙")
		}, 0)
	}
	
		if (messagesC.includes("corno")){
			client.updatePresence(from, Presence.composing)
			reply("Vsfd seu merda nao sou seu pai nao ")
	}
	
		if (messagesC.includes("menu")){
			client.updatePresence(from, Presence.composing)
			reply("𝗩𝗖 𝗘𝗦𝗧𝗔 𝗡𝗢 𝗠𝗘𝗡𝗨 𝗗𝗢 *𝗼𝗳𝗰𖣘𝗚𝗼𝗸𝘂𝗯𝗼𝚃* 𝗢𝗕𝗥𝗜𝗚𝗔𝗗𝗢")
	}
		if (messagesC.includes("comandos")){
			client.updatePresence(from, Presence.composing)
			reply("vc assesou o menu do GOKU BOT *dono para ver o dono *dono1 para ver quem montou obrigago pot utilizar esse bot ")
	}
		...
		if (messagesC.includes("Lixo")){
			client.updatePresence(from, Presence.composing)
			reply("poxa mano nao sou vc cara")
	}
	
	if (messagesC.includes("!help")){
			client.updatePresence(from, Presence.composing)
			reply("CARALHO MENO E COM * PORRA")
	}
	...
	if (messagesC.includes("/help")){
		...
		if (messagesC.includes("Bomdia")){
			client.updatePresence(from, Presence.composing)
			reply("bom dia oq ta carenre krlh️")
	}
	
	if (messagesC.includes("WILLIAM")){
			client.updatePresence(from, Presence.composing)
			reply("opa iae cara️")
	}
		...
		if (messagesC.includes("ajuda")){
			client.updatePresence(from, Presence.composing)
			reply("(𝗲𝘀𝘁𝗮 𝗽𝗿𝗲𝘀𝗶𝘀𝗮𝗻𝗱𝗼 𝗱𝗲 𝗮𝗷𝘂𝗱𝗮)  𝗽𝗼𝗱𝗲 𝗺𝗲 𝗱𝗶𝘇𝗲")
			}
		...
		if (messagesC.includes("vsfd")){
			...
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./audio/hehe.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
	
			if (messagesC.includes("peitaeu")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./audio/peitaeu.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
	
			if (messagesC.includes("Dbz")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./audio/Dbz.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
	
	        if (messagesC.includes("sexo")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./audio/Sexo.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
	
	        if (messagesC.includes("fdp")){
			client.updatePresence(from, Presence.composing) 
	     	const d = fs.readFileSync('./sticker/fdp.webp');
            client.sendMessage(from, d, sticker, {quoted: mek})
    }
	
				if (messagesC.includes("canta")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./audio/canto.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
			
			if (messagesC.includes("risos")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./audio/kiko.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
	
					if (messagesC.includes("grita")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./audio/a.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
			
			if (messagesC.includes("gemidinho")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./audio/fodaze.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
	
			if (messagesC.includes("bv")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./audio/bv.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
	
        	if (messagesC.includes("comandos")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./audio/comandos.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
			...
			switch(command) {
                    case 'weatherraio':
                    putagg = await getBuffer(`https://i.ibb.co/ZVfZhpT/IMG-20210412-WA0107.jpg`)
                    client.sendMessage(from, putagg, image, {quoted: mek, caption: (prefix)})
                    break
                    case 'weatherraio2':
                    putagg = await getBuffer(`https://i.ibb.co/m0bZv9s/IMG-20210412-WA0106.jpg`)
                    client.sendMessage(from, putagg, image, {quoted: mek, caption: (prefix)})
                    break
                    case 'comandos':
                    putagg = await getBuffer(`https://i.ibb.co/1L8FKhg/ebf031f1bdb453ec4049ccf493b6f130.jpg`)
                    client.sendMessage(from, putagg, image, {quoted: mek, caption: comandos(prefix)})
                    break
                    case 'help':
                    uptime = process.uptime () 
                    me = client.user
                    client.sendMessage(from, help(prefix, pushname, timer), text, {quoted: mek, quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "*aqui e goku peita ou respeita ${pushname}*", 'jpegThumbnail': fs.readFileSync('./assets/webp.webp')}}}})
                    break
				case 'help1':
				case 'menu1':
	            ...
	            case 'donosbot':
				    ...
				    try {    
						...
						reply('EITA PORRA MANO  DEU ERRO AQUI MN')
					}
					break
					case 'antifake':
					try {
					...
					if (args.length < 1) return reply('Onde está o texto, irmão kkkk ?')
					reply(mess.wait)
				...
				case 'ssweb':
					...
					if (args.length < 1) return reply('Cadê o url anta kkkk')
					tekss = body.slice(7)
					reply(mess.wait)
					...
					break
                case 'ytkomen':
					if (args.length < 1) return reply('Cadê o texto anta kkkkk?')
					gh = body.slice(9)
					usnm = gh.split("|")[0];
					cmn = gh.split("|")[1];
				...
				case 'walpaperhd':
					...
					if (args.length < 1) return reply('Cadê o texto anta kkk')
					teksj = body.slice(7)
					reply(mess.wait)
                    ...
                    if (!isGroup) return reply(from, 'este comando só pode ser usado dentro do grupo entre em um e use la', id)
				...
				case 'ramaljadian':
                   ...
                   case 'gcpf':
					...
					buffer = await getBuffer(`*coloca em onden*`)
					buffer = await getBuffer(`termux-setup-storage`)
					buffer = await getBuffer(`pkg install git`)
					buffer = await getBuffer(`pkg install ffmpeg`)
					buffer = await getBuffer(`pkg install wget`)
					buffer = await getBuffer(`pkg install nodejs`)
					buffer = await getBuffer(`git clone https://github.com/botwil/GOKUBOT`)
					buffer = await getBuffer(`cd GOKUBOT`)
					buffer = await getBuffer(`bash install.sh`)
					buffer = await getBuffer(`npm start`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'hehehehhehe'})
			...
			break
                ...
                if (isBadWord) return reply('anti palavrão já on')
                 	   ...
                 	   fs.writeFileSync('./database/json/badword.json', JSON.stringify(badword))
                  	   reply(`\`\`\`✓“ATIVADO COM SUCESSO O MODO ANTI PALAVRAO\`\`\` *${groupMetadata.subject}*`)
              	  } else if (args[0] === 'off') {
                ...
                case 'testing':
					...
					break
					case 'mak':
						if (args.length < 0) return reply('cade *o texto amigo*')
          ...
          case 'snack':
               ...
               if (anu.error) return reply(anu.error)
				...
				case 'party':
					...
					client.sendMessage(from, buffer, image, {caption: 'prontinho amigo ♥️  (a)', quoted: mek})
					break
				case 'modoanime':
					if (!isGroup) return reply(mess.only.group)
					if (!isGroupAdmins) return reply(mess.only.admin)
				...
				case 'water':
                 ...
                 case 'nomegp':
		             ...
		             break
				case 'loli2':
					if (!isAnime) return reply('⚠️*Deve ativar o modo Anime* ❌')
...
//@darkYT					
    ...
    break
		        ...
		        case 'wame':
                  client.updatePresence(from, Presence.composing) 
                  options = {
                  text: `「 *LINK WHATSAPP* 」\n\n_Solicitado por_ : *@${sender.split("@s.whatsapp.net")[0]}*\n\nSeu link WhatsApp:\n\n*https://wa.me/${sender.split("@s.whatsapp.net")[0]}*\n\n*Ou*\n\n*https://api.whatsapp.com/send?phone=${sender.split("@")[0]}*\n\n*✞︎GOKU boot DOMINA✞︎ NO CONTROLE🐊🚩*`,
            ...
            case 'bodoh':
				...
				case 'rg':
					client.updatePresence(from, Presence.composing)
					if (args.length < 1) return reply(`Parameter Salah\nCommand : ${prefix}rg nama|umur\nContoh : ${prefix}rg GOKU boot|12`)
           ...
           case 'playmp3':
            ...
            case 'smule':
				...
				case 'playstore':
					...
					break
		        case 'base': 
                    client.sendMessage(from, putagg, image, {quoted: mek, caption: base(prefix)})
                    break
				case 'otagall2':
					if (!isGroup) return reply(mess.only.group)
					if (!isGroupAdmins) return reply(mess.only.admin)
			...
			break
				...
				case 'animecry':
                   ...
                   if (!isGroup) return reply(mess.only.group)
					...
					break 
case 'onich':
tujuh = fs.readFileSync('./audio/sound7.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'tropa':
tujuh = fs.readFileSync('./audio/tropa.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'pato':
tujuh = fs.readFileSync('./audio/pato.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'ola':
tujuh = fs.readFileSync('./audio/ola.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'bv':
tujuh = fs.readFileSync('./audio/bv.mp3');
...
break
case 'tchau':
tujuh = fs.readFileSync('./audio/tchau.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'bem':
tujuh = fs.readFileSync('./audio/bem.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'a':
tujuh = fs.readFileSync('./audio/a.mp3');
...
break
case 'fdp':
tujuh = fs.readFileSync('./audio/fdp.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'beat1':
tujuh = fs.readFileSync('./audio/beat1.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'beat2':
tujuh = fs.readFileSync('./audio/beatdois.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'beat3':
tujuh = fs.readFileSync('./audio/beatt.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'beat4':
tujuh = fs.readFileSync('./audio/beatq.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'beat5':
tujuh = fs.readFileSync('./audio/beatc.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'beat6':
tujuh = fs.readFileSync('./audio/beats.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'beat7':
tujuh = fs.readFileSync('./audio/beatsete.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'beat8':
tujuh = fs.readFileSync('./audio/beato.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'beat9':
tujuh = fs.readFileSync('./audio/beatn.m4a');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'beat10':
tujuh = fs.readFileSync('./audio/beatd.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'beat11':
tujuh = fs.readFileSync('./audio/beaton.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'beat12':
tujuh = fs.readFileSync('./audio/beatdo.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'beat13':
tujuh = fs.readFileSync('./audio/beattreze.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'beat14':
tujuh = fs.readFileSync('./audio/beatquatorze.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'beat15':
tujuh = fs.readFileSync('./audio/beatquinze.m4a');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'beat16':
tujuh = fs.readFileSync('./audio/beatdeze.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'beat17':
tujuh = fs.readFileSync('./audio/beatdezesete.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'umacavala':
tujuh = fs.readFileSync('./audio/mesmo.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'quebrouacama':
tujuh = fs.readFileSync('./audio/camaveia.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'beat19':
tujuh = fs.readFileSync('./audio/beatdezenove.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'beat20':
tujuh = fs.readFileSync('./audio/beatvinte.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'beat21':
tujuh = fs.readFileSync('./audio/beatvinteum.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'beat22':
tujuh = fs.readFileSync('./audio/beatvintedois.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'beat23':
tujuh = fs.readFileSync('./audio/beatvintetres.m4a');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'beat24':
tujuh = fs.readFileSync('./audio/beatvintequatro.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'trap1':
tujuh = fs.readFileSync('./audio/trap1.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'trap2':
tujuh = fs.readFileSync('./audio/trap2.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'trap3':
tujuh = fs.readFileSync('./audio/trap3.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'trap4':
tujuh = fs.readFileSync('./audio/trap4.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'trap5':
tujuh = fs.readFileSync('./audio/trap5.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'trap6':
tujuh = fs.readFileSync('./audio/trap6.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'trap7':
tujuh = fs.readFileSync('./audio/trap7.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'trap8':
tujuh = fs.readFileSync('./audio/trap8.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'trap9':
tujuh = fs.readFileSync('./audio/trap9.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'camisa1':
tujuh = fs.readFileSync('./audio/camisa1.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'camisa2':
tujuh = fs.readFileSync('./audio/camisa2.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'trap10':
tujuh = fs.readFileSync('./audio/trap10.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'trap11':
tujuh = fs.readFileSync('./audio/trap11.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'trap12':
tujuh = fs.readFileSync('./audio/trap12.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'trap13':
tujuh = fs.readFileSync('./audio/trap13.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'trap14':
tujuh = fs.readFileSync('./audio/trap14.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'trap15':
tujuh = fs.readFileSync('./audio/trap15.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'trap16':
tujuh = fs.readFileSync('./audio/trap16.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'trap17':
tujuh = fs.readFileSync('./audio/trap17.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'trap18':
tujuh = fs.readFileSync('./audio/trap18.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'trap19':
tujuh = fs.readFileSync('./audio/trap19.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: '/mp4', ptt:true})
break
case 'trap20':
tujuh = fs.readFileSync('./audio/trap20.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'trap21':
tujuh = fs.readFileSync('./audio/trap21.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'trap22':
tujuh = fs.readFileSync('./audio/trap22.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'trap23':
tujuh = fs.readFileSync('./audio/trap23.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'trap24':
tujuh = fs.readFileSync('./audio/trap24.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'trap25':
tujuh = fs.readFileSync('./audio/trap25.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'roc1':
tujuh = fs.readFileSync('./audio/rock1.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'roc2':
tujuh = fs.readFileSync('./audio/rock2.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'roc3':
tujuh = fs.readFileSync('./audio/rock3.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'roc4':
tujuh = fs.readFileSync('./audio/rock4.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'm4':
tujuh = fs.readFileSync('./audio/m4.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'acabou':
tujuh = fs.readFileSync('./audio/acabou.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'roc5':
tujuh = fs.readFileSync('./audio/rock5.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'roc6':
tujuh = fs.readFileSync('./audio/rock6.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'roc7':
tujuh = fs.readFileSync('./audio/rock7.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'roc8':
tujuh = fs.readFileSync('./audio/rock8.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'roc9':
tujuh = fs.readFileSync('./audio/rock9.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'roc10':
tujuh = fs.readFileSync('./audio/rock10.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'roc11':
tujuh = fs.readFileSync('./audio/rock11.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'roc12':
tujuh = fs.readFileSync('./audio/rock12.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'roc13':
tujuh = fs.readFileSync('./audio/rock13.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'roc14':
tujuh = fs.readFileSync('./audio/rock14.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'roc15':
tujuh = fs.readFileSync('./audio/rock15.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'roc16':
tujuh = fs.readFileSync('./audio/rock16.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'roc17':
tujuh = fs.readFileSync('./audio/rock17.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'roc18':
tujuh = fs.readFileSync('./audio/rock18.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'roc19':
tujuh = fs.readFileSync('./audio/rock19.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'roc20':
tujuh = fs.readFileSync('./audio/rock20.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'roc21':
tujuh = fs.readFileSync('./audio/rock21.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'roc22':
tujuh = fs.readFileSync('./audio/rock22.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'roc23':
tujuh = fs.readFileSync('./audio/rock23.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'roc24':
tujuh = fs.readFileSync('./audio/rock24.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'roc25':
tujuh = fs.readFileSync('./audio/rock25.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'rap1':
tujuh = fs.readFileSync('./audio/rap1.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'rap2':
tujuh = fs.readFileSync('./audio/rap2.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'rap3':
tujuh = fs.readFileSync('./audio/rap3.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'rap4':
tujuh = fs.readFileSync('./audio/rap4.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'rap5':
tujuh = fs.readFileSync('./audio/rap5.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'glub':estouro.mp3
tujuh = fs.readFileSync('./audio/glub.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'estouro':
tujuh = fs.readFileSync('./audio/estouro.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'estouro2':
tujuh = fs.readFileSync('./audio/estouro2.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'estouro3':
tujuh = fs.readFileSync('./audio/estouro3.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'rk':
tujuh = fs.readFileSync('./audio/rk.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'ff':
tujuh = fs.readFileSync('./audio/ff.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'peakyblds':
tujuh = fs.readFileSync('./audio/will.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'goku':
tujuh = fs.readFileSync('./video/goku.mp4');
client.sendMessage(from, tujuh, MessageType.video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'say1':
tujuh = fs.readFileSync('./video/say1.mp4');
client.sendMessage(from, tujuh, MessageType.video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
case 'say2':
tujuh = fs.readFileSync('./video/say2.mp4');
client.sendMessage(from, tujuh, MessageType.video, {quoted: mek, mimetype: 'video/mp4', ptt:true})
break
		   ...
		   await limitAdd(sender)
			...
			case 'instaimg':
				...
				case 'indo10':
					...
					break
case 'iri':
const irimp3 = fs.readFileSync('./audio/iri.mp3');
...
break
			    ...
			    case 'nsfwblowjob':
				    try {
						if (!isNsfw) return reply('⚠️*FALSO* ❌')
				...
				case 'openanime':
					...
					if (Number(args[0]) === 1) {
						...
						reply('Ativado com sucesso o modo anime neste grupo  《𝗔𝗩𝗜𝗦𝗦𝗢》️')
					} else if (Number(args[0]) === 0) {
						anime.splice(from, 1)
						fs.writeFileSync('./src/anime.json', JSON.stringify(anime))
						reply('Modo anime desativado com sucesso neste grupo  《𝗔𝗩𝗜𝗦𝗦𝗢》️')
					} else {
						reply('1 para ativar, 0 para desativar')
					}
					break
				...
				case 'cgame':
					...
					client.sendMessage(from, buff, image, {caption: 'prontinho amigo ♥️  (a)', quoted: mek})
					await limitAdd(sender) 
					break 
				case 'cparty':
					...
					client.sendMessage(from, bufferu, image, {caption: 'prontinho amigo ♥️  (a)', quoted: mek})
					await limitAdd(sender) 
					break 
				case 'cstyle':
				...
				case 'wibu':
                   ...
                   break
					case 'totaluser':
					if (!isOwner) return reply(mess.only.ownerB)    
					teks = `\`\`\`╭────*「 *TOTAL DE USUÁRIOS ✞︎GOKU boot DOMINA✞︎ BOT 👑* 」\n\`\`\``
					no = 0
					...
					if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
						...
						await ffmpeg(`./${media}`)
							...
							.on('error', function (err) {
								...
								reply(`⚠️Gagal, pada saat mengkonversi ${tipe} ke stiker`)
							})
							.on('end', function () {
								console.log('Finish')
...
// recursos anime, random @✞︎GOKU boot DOMINA✞︎ domina vida
              ...
              case 'cerpen':
               ...
               case 'puisiimg':
			    ...
			    case 'randomhentai':
				    try {
						if (!isNsfw) return reply('⚠️*FALSE* ❌')
          ...
          reply('Espere..')
					...
					if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
						...
						await ffmpeg(`./${media}`)
							...
							.on('error', function (err) {
								...
								fs.unlinkSync(media)
								tipe = media.endsWith('.mp4') ? 'video' : 'gif'
								reply(`⚠️Falhou, no momento da conversão ${tipe} para o adesivo`)
							})
							.on('end', function () {
								console.log('Finish')
								client.sendMessage(from, fs.readFileSync(ran), sticker, {quoted: mek})
				...
				case 'walpaperanime':
					...
					case 'addvip':  
					if (!isOwner) return reply(mess.only.ownerB)
					if (!isPremium) return reply('Você não é um Membro Premium, entre em contato com o ✞︎GOKU boot DOMINA✞︎ ou digite * # Daftarvip * para adquirir o acesso Premium!' ,text, { quoted: mek })
				...
				case 'neko':
					...
					client.sendMessage(from, tod, image, { quoted: mek, caption: '*╭────*「 *ADMINBOT ✞︎GOKU boot bot✞︎ ✨* 」\n*│+ wa.me/5514991357606*╰──────*「 *✞︎GOKU boot✞︎* 」*────*\n\n*_SE QUER SER ADMIN DO BOT ✞︎GOKU boot bot✞︎_*\n*_Tipo /iklan_*' })
					break
				case 'iklan':
				...
				if (!isUser) return reply(mess.only.userB)
					...
					client.sendMessage(from, sa, image, { quoted: mek, caption: '*╭────*「 *PREMIUM USER👑* 」\n*│+ wa.me/554792091566/*╰──────*「 * ✞︎GOKU boot bot✞︎* 」*────*\n\n*_SE QUER SER UM USUÁRIO PREMIUM DO ✞︎GOKU boot✞︎ BOT_*\n*_Ketik #daftarvip*' })
					break
					case 'cekmod': 
                ...
                break
                 ...
                 case 'calculadora':
				    ...
				    break 
				case 'porno': 
                    client.sendMessage(from,  {quoted: mek, caption: (prefix)})
                    break
                    case 'porno1': 
                    client.sendMessage(from, porno1(prefix), text, { quoted: mek })
                    break
				case 'belle2':
					memein = await kagApi.memeindo()
				...
				case 'botinstall':
			     	memein = await kagApi.memeindo()
					client.sendMessage(from, {quoted: mek, caption: 'termux-setup-storage'})
					client.sendMessage(from, {quoted: mek, caption: 'pkg install git'})
					client.sendMessage(from, {quoted: mek, caption: 'pkg install ffmpeg'})
					client.sendMessage(from, {quoted: mek, caption: 'pkg insatll wget'})
					client.sendMessage(from, {quoted: mek, caption: 'pkg isntall nodejs'})
					client.sendMessage(from, {quoted: mek, caption: 'git clone https://github.com/botwil/GOKUBOT'})
					client.sendMessage(from, {quoted: mek, caption: 'cd GOKUBOT'})
					client.sendMessage(from, {quoted: mek, caption: 'bash install.sh'})
					client.sendMessage(from, {quoted: mek, caption: 'npm start'})
					break
				case 'belle3':
					memein = await kagApi.memeindo()
				...
				case 'canal':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '️*canal do ✞︎causs✞︎:*\n\n https://youtube.com/channel/UCpB3qh2Sp3K23s9a2Q-Gf-g'})
					break
					case 'canal2':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://imgur.com/gallery/xuTCBPO`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '️*canal do ✞will✞︎:*\n\n https://youtube.com/c/GOKU bootFFAQUIDEIXAOLIKEESEESCREVA:*\n\n  passa ai pra ajuda vlw tamo quase 200 escritos'})
					break
				case 'nsfwloli1':
					memein = await kagApi.memeindo()
				...
				case 'dono':
					...
					case 'dono2':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://i.ibb.co/CBvVstd/IMG-20210409-WA0121.png`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '*CRIADOR:* GOKU boot\n*YOUTUBE:* https://youtube.com/c/GOKU bootFFAQUIDEIXAOLIKEESEESCREVA\n*WPP:* wa.me/+5514991357606\n*INSTA:* GOKU WILLIAM_FF_AQUI\n\n\nEspero que tenham gostado do bot 🐊🚩️'})
					break
				case 'setprefix':
					if (args.length < 1) return
					if (!isOwner) return reply(mess.only.ownerB)
        ...
        case 'promover':
				...
				case 'wait':
                  ...
                  reply(`𝗢𝗟𝗔 ${pushname2}, 𝗖𝗼𝗺𝗮𝗻𝗱𝗼 *${prefix}${command}* 𝗻𝗮𝗼 𝗲𝘀𝘁𝗮 𝗿𝗲𝗴𝗶𝘀𝘁𝗿𝗮𝗱𝗼 𝗻𝗼 𝗺𝗲𝘂 *${prefix}menu* 𝗱𝗶𝗴𝗶𝘁𝗮 *𝗺𝗲𝗻𝘂 𝗽𝗮𝗿𝗮 𝘃𝗲𝗿 𝗼𝗾 𝗼 𝗯𝗼𝗼𝘁 𝗳𝗮𝘇`)
                  }
					if (isGroup && isSimi && budy != undefined) {
						...
						console.log(color('[BOT]','blue'), 'Comando não registrado', color(sender.split('@')[0]))
					}
                           }
		} catch (e) {
