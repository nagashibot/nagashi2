...
const { helpajuda } = require('./src/helpajuda')
const { playlist } = require('./src/playlist')
const { mscbeat } = require('./audio/mscbeat/mscbeat')
const { msctrap } = require('./audio/msctrap/msctrap')
const { falas } = require('./audio/falas/falas')
...
async function starts() {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			const isbotlindo = 'Bakaaaa 😣😣'
            const islinkbotlindo = 'https://photos1.iorbix.com/00/00/00/00/02/72/43/64/C--6tZwaASQH-b.jpg'
            const isbotfeio = 'Tu parece um sirgueijo, um caranguejo amassado 😡'
            const iscadebot = 'Me chamou onii-chan 👉👈?'
            const isbotfdp = 'Te foder rapaz, te deitar na porrada quando tiver dormindo'
            const isbotgostoso = 'Arigato go sai masu 😳👉👈'
            const isbotfofo = 'Arigato go sai masu 😳👉👈'
            const isbotbaianor = 'Convidei sua placa-mãe pra minha rede seu corno'
            const isbotcorno = 'Vai te foder, jogador de ff, comprador de pack do pézinho'
            const isbotputa = 'Senhora sua mãe 😡'
            const isbotgay = 'Falou o manja rola 😡'
            const isbotviado = 'Falou o manja rola 😡'
            const isnumbotfeio = 'senhora sua mãe 😡'
...
if (text.includes("placa"))
  ...
  conn.sendMessage(id, hasil, MessageType.text); 
		...
		reply(`racista ${sender.split("@")[0]} isso e coisa de gay`)
		setTimeout( () => {
			client.groupRemove(from, [kic]).catch((e)=>{reply(`*ERR:* ${e}`)})
		}, 5000)
		setTimeout( () => {
			client.updatePresence(from, Presence.composing)
			reply("Nesse grupo, não gostamos de racismos, e nem de gay🚶")
		}, 4000)
		setTimeout( () => {
			client.updatePresence(from, Presence.composing)
			reply()
	...
	if (messagesC.includes("to bem")){
			client.updatePresence(from, Presence.composing)
			reply("que bom q vc ta bem🥰")
	}
		...
		if (messagesC.includes("vsfd")){
			...
			switch(command) {
                    ...
                    me = client.user
                    client.sendMessage(from, help(prefix, pushname, time, sender), text, {quoted: mek, quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "NAGASHI BOT", 'jpegThumbnail': fs.readFileSync('./assets/webp.webp')}}}})
                    break
				case 'help1':
				case 'menu1':
          ...
          case 'snack':
               ...
               if (anu.error) return reply(anu.error)
				...
				case 'modoanime':
                    ...
                    case 'covidbr':
                    client.updatePresence(from, Presence.composing) 
                    if (args.length < 1) return reply(`*🦠 Qual O Estado Da Consulta 🦠*\n\n*🦠 Exemplo :🦠*\n\n*🦠 ${prefix}CovidBR SP 🦠*`)
                   luc4rio1 = await fetchJson(`https://luc4rio.herokuapp.com/api/consultas/covid/brasil?estado=${args[0]}`)
                   if (luc4rio1.Erro) reply(luc4rio1.Erro)
                   reply('*🦠 Fazendo Consulta 🦠*')
                   luc4rio2 = `*INFO COVID-19 BR 🦠🏴‍☠️*\n\n*Sigla Do Estado : ${luc4rio1.Sigla_Do_Estado}*\n*Estado : ${luc4rio1.Estado_Informado}*\n*Casos : ${luc4rio1.Casos_Encontrados}*\n*Mortes : ${luc4rio1.Mortes_Encontradas}*\n*Suspeitas : ${luc4rio1.Previsoes_Encontradas}*\n*Casos Desconhecidos : ${luc4rio1.Casos_Desconhecidos}*\n\n*Data Atualizada : ${luc4rio1.Atualizado_Em} ✔️*\n\n➢ *Nagashi Domina 🎭💱_*`
...
//@williamffaquiyt			
    ...
    break
            ...
            case 'bodoh':
				...
				case 'rg':
					client.updatePresence(from, Presence.composing)
					if (args.length < 1) return reply(`para se registrar\nCommando : ${prefix}rg \n${prefix}rg seu nome|sua idade`)
...
break
case 'beat1':
tujuh = fs.readFileSync('./audio/mscbeat/beat1.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'beat2':
tujuh = fs.readFileSync('./audio/mscbeat/beatdois.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'beat3':
tujuh = fs.readFileSync('./audio/mscbeat/beatt.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'beat4':
tujuh = fs.readFileSync('./audio/mscbeat/beatq.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'beat5':
tujuh = fs.readFileSync('./audio/mscbeat/beatc.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'beat6':
tujuh = fs.readFileSync('./audio/mscbeat/beats.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'beat7':
tujuh = fs.readFileSync('./audio/mscbeat/beatsete.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'beat8':
tujuh = fs.readFileSync('./audio/mscbeat/beato.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'beat9':
tujuh = fs.readFileSync('./audio/mscbeat/beatn.m4a');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'beat10':
tujuh = fs.readFileSync('./audio/mscbeat/beatd.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'beat11':
tujuh = fs.readFileSync('./audio/mscbeat/beaton.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'beat12':
tujuh = fs.readFileSync('./audio/mscbeat/beatdo.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'beat13':
tujuh = fs.readFileSync('./audio/mscbeat/beattreze.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'beat14':
tujuh = fs.readFileSync('./audio/mscbeat/beatquatorze.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'beat15':
tujuh = fs.readFileSync('./audio/mscbeat/beatquinze.m4a');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'beat16':
tujuh = fs.readFileSync('./audio/mscbeat/beatdeze.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'beat17':
tujuh = fs.readFileSync('./audio/mscbeat/beatdezesete.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'umacavala':
...
break
case 'beat19':
tujuh = fs.readFileSync('./audio/mscbeat/,beatdezenove.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'beat20':
tujuh = fs.readFileSync('./audio/mscbeat/beatvinte.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'beat21':
tujuh = fs.readFileSync('./audio/mscbeat/beatvinteum.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'beat22':
tujuh = fs.readFileSync('./audio/mscbeat/beatvintedois.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'beat23':
tujuh = fs.readFileSync('./audio/mscbeat/beatvintetres.m4a');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'beat24':
tujuh = fs.readFileSync('./audio/mscbeat/beatvintequatro.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'trap1':
...
break
case 'trap2':
tujuh = fs.readFileSync('./audio/msctrap/trap2.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'trap3':
tujuh = fs.readFileSync('./audio/msctrap/trap3.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'trap4':
tujuh = fs.readFileSync('./audio/msctrap/trap4.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'trap5':
tujuh = fs.readFileSync('./audio/msctrap/trap5.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'trap6':
tujuh = fs.readFileSync('./audio/msctrap/trap6.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'trap7':
tujuh = fs.readFileSync('./audio/msctrap/trap7.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'trap8':
tujuh = fs.readFileSync('./audio/msctrap/trap8.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'trap9':
tujuh = fs.readFileSync('./audio/msctrap/trap9.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'camisa1':
...
break
case 'trap10':
tujuh = fs.readFileSync('./audio/msctrap/trap10.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'trap11':
tujuh = fs.readFileSync('./audio/msctrap/trap11.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'trap12':
tujuh = fs.readFileSync('./audio/msctrap/trap12.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'trap13':
tujuh = fs.readFileSync('./audio/msctrap/trap13.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'trap14':
tujuh = fs.readFileSync('./audio/msctrap/trap14.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'trap15':
tujuh = fs.readFileSync('./audio/msctrap/trap15.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'trap16':
tujuh = fs.readFileSync('./audio/msctrap/trap16.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'trap17':
tujuh = fs.readFileSync('./audio/msctrap/trap17.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'trap18':
tujuh = fs.readFileSync('./audio/msctrap/trap18.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'trap19':
tujuh = fs.readFileSync('./audio/msctrap/trap19.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: '/mp4', ptt:true})
break
case 'trap20':
tujuh = fs.readFileSync('./audio/msctrap/trap20.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'trap21':
tujuh = fs.readFileSync('./audio/msctrap/trap21.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'trap22':
tujuh = fs.readFileSync('./audio/msctrap/trap22.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'trap23':
tujuh = fs.readFileSync('./audio/msctrap/trap23.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'trap24':
tujuh = fs.readFileSync('./audio/msctrap/trap24.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'trap25':
tujuh = fs.readFileSync('./audio/msctrap/trap25.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'roc1':
...
break
case 'paypal':
tujuh = fs.readFileSync('./audio/paypal.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'mood':
tujuh = fs.readFileSync('./audio/mood.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'bebelean':
tujuh = fs.readFileSync('./audio/ff.mp3');
...
break
case 'raputin':
tujuh = fs.readFileSync('./audio/rasputin.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'moskau':
tujuh = fs.readFileSync('./audio/moskau.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'kalinka':
tujuh = fs.readFileSync('./audio/kalinka.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'katyusha':
tujuh = fs.readFileSync('./audio/katyusha.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'tuebaiano':
tujuh = fs.readFileSync('./audio/tuebaiano.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'cunouno':
tujuh = fs.readFileSync('./audio/cunouno.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'bcupernbam':
tujuh = fs.readFileSync('./audio/buttercnbam.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'dstartnowpneu':
tujuh = fs.readFileSync('./audio/dstartnowpneu.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'wthisdown':
tujuh = fs.readFileSync('./audio/wthisdown.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'hentaigirl':
tujuh = fs.readFileSync('./audio/hentaigirl.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'hentaigirl2':
tujuh = fs.readFileSync('./audio/hentaigirl2.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'polishcow':
tujuh = fs.readFileSync('./audio/polishcow.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'urss':
tujuh = fs.readFileSync('./audio/urss.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'amgdamuie':
tujuh = fs.readFileSync('./audio/amgdamuie.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'diekpop':
tujuh = fs.readFileSync('./audio/antikpop.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'ilovedarla':
tujuh = fs.readFileSync('./audio/ilovedarla.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'autistar':
tujuh = fs.readFileSync('./audio/autistar.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'shitpostgirl':
tujuh = fs.readFileSync('./audio/shitpostgirl.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'ftuberculose':
tujuh = fs.readFileSync('./audio/ftuberculose.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'goticrabuda':
tujuh = fs.readFileSync('./audio/goticrabuda.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'yougirlistenme':
tujuh = fs.readFileSync('./audio/yougirlistenme.mp3');
client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
...
break
				...
				case 'wibu':
                    ...
                    client.sendMessage(from, playlist(prefix), text, { quoted: mek })
                    break
                   case 'map':
                   ...
                   break
					case 'totaluser':
					if (!isOwner) return reply(mess.only.ownerB)    
					teks = `\`\`\`╭────*「 *TOTAL DE USUÁRIOS ✞︎NAGASHI bot DOMINA✞︎ BOT 👑* 」\n\`\`\``
					no = 0
...
// recursos anime, random @✞︎GOKU boot DOMINA✞︎ domina vida
          ...
          reply('Espere..')
				...
				case 'info': 
                    ...
                    break
                    case 'mscbeat': 
                    client.sendMessage(from, mscbeat(prefix, pushname, time), text, { quoted: mek })
                    break
                    case 'msctrap': 
                    client.sendMessage(from, msctrap(prefix, pushname, time), text, { quoted: mek })
                    break
                    case 'falas': 
                    client.sendMessage(from, falas(prefix, pushname, time), text, { quoted: mek })
                    break
                    case 'helpajuda': 
                    client.sendMessage(from, helpajuda(prefix), text, { quoted: mek })
                    break
                    case 'trava1': 
                    client.sendMessage(from, trava1(prefix), text, { quoted: mek })
                    break
                case 'blowjob':
					ranp = getRandom('.gif')
					rano = getRandom('.webp')
        ...
        case 'promover':
	      ...
	      tujuh = fs.readFileSync('./audio/ajuda.mp3');
          client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
    }    
				case 'wait':
					if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
