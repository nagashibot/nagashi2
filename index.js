...
// recursos anime, random @✞︎NAGASHI bot DOMINA✞︎ domina vida
          ...
          reply('Espere..')
				...
				case 'walpaperanime':
					...
					case 'addvip':  
					if (!isOwner) return reply(mess.only.ownerB)
					if (!isPremium) return reply('Você não é um Membro Premium, entre em contato com Nagashi  ou digite * # Daftarvip * para adquirir o acesso Premium!' ,text, { quoted: mek })
				...
				case 'neko':
					...
					client.sendMessage(from, tod, image, { quoted: mek, caption: '*╭────*「 *ADMINBOT ✞︎NAGASHI boot bot✞︎ ✨* 」\n*│+ wa.me/5581987685591*╰──────*「 *✞︎nagash boot✞︎* 」*────*\n\n*_SE QUER SER ADMIN DO BOT nagashibot✞︎_*\n*_Tipo /iklan_*' })
					break
				case 'iklan':
				...
				if (!isUser) return reply(mess.only.userB)
					...
					client.sendMessage(from, sa, image, { quoted: mek, caption: '*╭────*「 *PREMIUM USER👑* 」\n*│+ wa.me/5581987688591/*╰──────*「 Nagashi 」*────*\n\n*_SE QUER SER UM USUÁRIO PREMIUM DO nagashibot_*\n*_Ketik #daftarvip*' })
					break
					case 'cekmod': 
				...
				case 'dono':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'https://www.youtube.com/channel/UCWGkx328NVOgCfd78tmx-_g'})
					break
				case 'setprefix':
					if (args.length < 1) return
					if (!isOwner) return reply(mess.only.ownerB)
        ...
        case 'promover':
				...
				case 'bemvindo':
					...
					if (Number(args[0]) === 1) {
						...
						reply('1 para ativar, 0 para desativar, corno vc em KAKKKK')
					}
                                      break
				case 'clonar':
					if (!isGroup) return reply(mess.only.group)
